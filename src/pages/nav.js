   ...
   return (
      <div style={{textAlign:"center"}}>
        <nav>
         ...
         <Link to="/home" activeClassName="active" className="link-logo"><StaticImage src="../images/smallerLogo.png" alt="Logo" layout="fixed" className="nav-logo"></StaticImage></Link>
